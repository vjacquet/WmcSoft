...
namespace WmcSoft.Data.SqlClient
{
    public class SqlDataType
    {
        ...
        {
            // reused default settings by wrapping the properties in a parameter.
            DbType = p.SqlDbType;
            Size = p.Size;
        ...
        static string Format(SqlDbType dbType)
        {
            return dbType.ToString().ToLowerInvariant();
        }
        ...
        static string Format(byte precision, byte scale)
        {
        ...
        {
            if (Defaults.TryGetValue(typeof(T), out var result))
                return result;
            throw new NotSupportedException();
        }
