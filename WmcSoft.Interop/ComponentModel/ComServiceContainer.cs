...
namespace WmcSoft.ComponentModel
{
    ...
    /// </summary>
    public abstract class ComServiceContainer : IServiceContainer, IServiceProvider, IOleServiceProvider, IDisposable
    {
        #region Fields & Ctors
        ...
        /// </summary>
        public ComServiceContainer(IServiceProvider provider)
        {
            _provider = provider;
        ...
        {
            if (_container == null && _proffer == null)
                return;
