...
namespace WmcSoft.Windows.Forms
{
    public static class NativeMethods
    {
        ...
        extern static IntPtr SendMessage(System.IntPtr hwnd, int msg, IntPtr wparam, IntPtr lparam);

        [DllImport("user32.dll", CharSet = CharSet.Auto, ExactSpelling = true)]
        static extern bool IsWindowVisible(IntPtr hWnd);

        [DllImport("user32.dll", CharSet = CharSet.Auto, ExactSpelling = true)]
        static extern bool MessageBeep(int type);
        ...
        internal const uint HTVSCROLL = 0x7;

        public static void SendMessage(this Control self, ref Message message) {
            message.Result = SendMessage(self.Handle, message.Msg, message.WParam, message.LParam);
        }
