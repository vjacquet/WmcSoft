...
namespace WmcSoft
{
    ...
    public partial struct Longitude : IXmlSerializable
    {
        class LongitudeConverter : TypeConverter
        {
            ...
            static Longitude ParseInvariant(string input)
            {
            ...
            public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
            {
                if (value is Longitude l) {
                    if (destinationType == typeof(InstanceDescriptor)) {
                        ...
                        decimal degrees = l;
                        return degrees >= 0
                            ? string.Format(CultureInfo.InvariantCulture, "+{0:000.######}", degrees)
                            : string.Format(CultureInfo.InvariantCulture, "-{0:000.######}", -degrees);
                    }
                }
