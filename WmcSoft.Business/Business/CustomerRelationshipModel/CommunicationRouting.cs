...
{
    /// <summary>
    /// Special case of <see cref="Communication"/> that represents a handover between CustomerServiceRepresentatives.
    /// </summary>
    public abstract class CommunicationRouting : Communication
    {
        #region Lifecycle
