...
namespace WmcSoft.Data
{
    public static class DataRowCollectionExtensions
    {
        ...
        public static IEnumerable<DataRow> Where(this DataTable table, Func<DataRow, bool> predicate) {
            return table.Rows.Cast<DataRow>().Where(predicate);
        }

        public static IEnumerable<U> Select<U>(this DataTable table, Func<DataRow, U> selector) {
            return table.Rows.Cast<DataRow>().Select(selector);
        }
        public static IEnumerable<V> SelectMany<U, V>(this DataTable table, Func<DataRow, IEnumerable<U>> selector, Func<DataRow, U, V> resultSelector) {
            return table.Rows.Cast<DataRow>().SelectMany(selector, resultSelector);
        }
        ...
        public static IEnumerable<V> Join<U, K, V>(this DataTable table, IEnumerable<U> inner, Func<DataRow, K> outerKeySelector, Func<U, K> innerKeySelector, Func<DataRow, U, V> resultSelector) {
            return table.Rows.Cast<DataRow>().Join(inner, outerKeySelector, innerKeySelector, resultSelector);
        }
        ...
        public static IEnumerable<V> GroupJoin<U, K, V>(this DataTable table, IEnumerable<U> inner, Func<DataRow, K> outerKeySelector, Func<U, K> innerKeySelector, Func<DataRow, IEnumerable<U>, V> resultSelector) {
            return table.Rows.Cast<DataRow>().GroupJoin(inner, outerKeySelector, innerKeySelector, resultSelector);
        }

        public static IOrderedEnumerable<DataRow> OrderBy<K>(this DataTable table, Func<DataRow, K> keySelector) {
            return table.Rows.Cast<DataRow>().OrderBy(keySelector);
        }

        public static IOrderedEnumerable<DataRow> OrderByDescending<K>(this DataTable table, Func<DataRow, K> keySelector) {
            return table.Rows.Cast<DataRow>().OrderByDescending(keySelector);
        }

        public static IEnumerable<IGrouping<K, DataRow>> GroupBy<K>(this DataTable table, Func<DataRow, K> keySelector) {
            return table.Rows.Cast<DataRow>().GroupBy(keySelector);
        }
        ...
        public static IEnumerable<IGrouping<K, E>> GroupBy<K, E>(this DataTable table, Func<DataRow, K> keySelector, Func<DataRow, E> elementSelector) {
            return table.Rows.Cast<DataRow>().GroupBy(keySelector, elementSelector);
        }
