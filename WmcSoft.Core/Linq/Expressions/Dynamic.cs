...
//This class comes from code sample. I do not know yet if I keep it here, if I move it to another assembly, or if I remove it.
...
namespace System.Linq.Dynamic
{
    public static class DynamicQueryable
    {
        ...
        static Expression Call(string methodName, params Expression[] arguments) {
            return Expression.Call(typeof(Queryable), methodName, null, arguments);
        }
        static Expression Call(string methodName, Type type, params Expression[] arguments) {
            return Expression.Call(typeof(Queryable), methodName, new[] { type }, arguments);
        }
        static Expression Call(string methodName, Type type1, Type type2, params Expression[] arguments) {
            return Expression.Call(typeof(Queryable), methodName, new[] { type1, type2 }, arguments);
        }
        static Expression Call(string methodName, Type type1, Type type2, Type type3, params Expression[] arguments) {
            return Expression.Call(typeof(Queryable), methodName, new[] { type1, type2, type3 }, arguments);
        }
        #endregion
        ...
        public static IQueryable Where(this IQueryable source, string predicate, params object[] values) {
            ...
            var expr = Call("Where", source.ElementType, source.Expression, Expression.Quote(lambda));
        ...
        public static IQueryable Select(this IQueryable source, string selector, params object[] values) {
            ...
            var expr = Call("Select", source.ElementType, lambda.Body.Type, source.Expression, Expression.Quote(lambda));
            return source.Provider.CreateQuery(expr);
        }
        ...
        public static IQueryable OrderBy(this IQueryable source, string ordering, params object[] values) {
            ...
            foreach (var o in orderings) {
                queryExpr = Call(o.Ascending ? methodAsc : methodDesc, source.ElementType, o.Selector.Type, queryExpr, Expression.Quote(Expression.Lambda(o.Selector, parameters)));
                methodAsc = "ThenBy";
        ...
        public static IQueryable Take(this IQueryable source, int count) {
            if (source == null)
                throw new ArgumentNullException("source");
            var expr = Call("Take", source.ElementType, source.Expression, Expression.Constant(count));
            return source.Provider.CreateQuery(expr);
        }
        ...
        public static IQueryable Skip(this IQueryable source, int count) {
            if (source == null)
                throw new ArgumentNullException("source");
            var expr = Call("Skip", source.ElementType, source.Expression, Expression.Constant(count));
            return source.Provider.CreateQuery(expr);
        }
        ...
        public static IQueryable GroupBy(this IQueryable source, string keySelector, string elementSelector, params object[] values) {
            ...
            var expr = Call("GroupBy", source.ElementType, keyLambda.Body.Type, elementLambda.Body.Type, source.Expression, Expression.Quote(keyLambda), Expression.Quote(elementLambda));
            return source.Provider.CreateQuery(expr);
        }
        ...
        public static bool Any(this IQueryable source) {
            if (source == null)
                throw new ArgumentNullException("source");
            var expr = Call("Any", source.ElementType, source.Expression);
            return (bool)source.Provider.Execute(expr);
        }

        public static int Count(this IQueryable source) {
            if (source == null)
                throw new ArgumentNullException("source");
            var expr = Call("Count", source.ElementType, source.Expression);
            return (int)source.Provider.Execute(expr);
        }
    }
