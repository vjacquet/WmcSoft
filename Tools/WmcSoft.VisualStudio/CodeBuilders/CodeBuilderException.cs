...
namespace WmcSoft.CodeBuilders
{
    ...
    public class CodeBuilderException : Exception
    {
        ...
        public CodeBuilderException(string message, Exception inner) : base(message, inner) { }
        protected CodeBuilderException(SerializationInfo info, StreamingContext context)
            : base(info, context) { }
    }
}
